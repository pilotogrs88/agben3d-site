const hotfix=document.createElement('link');hotfix.rel='stylesheet';hotfix.href='assets/v5-hotfix.css?v=51';document.head.appendChild(hotfix);
const items=[['capivara','Capivara Calma','Decoração','89,90','assets/capivara.svg'],['gatos','Gatos Decorativos','Decoração','99,90','assets/gatos.svg'],['gato-geometrico','Gato Geométrico','Decoração','79,90','assets/gato-geometrico.svg'],['leitor','Leitor Abstrato','Presentes','89,90','assets/leitor.svg'],['suporte-livros','Suporte para Livros','Organização','69,90','assets/suporte-livros.svg']];
const catalogItems=[...items,
['vaso-geometrico','Vaso Geométrico Mini','Decoração','59,90','assets/gato-geometrico.svg'],
['porta-lapis','Porta-lápis Hexagonal','Organização','49,90','assets/suporte-livros.svg'],
['luminaria-lunar','Luminária Lunar','Decoração','129,90','assets/leitor.svg'],
['chaveiro-personalizado','Chaveiro Personalizado','Presentes','24,90','assets/capivara.svg'],
['organizador-mesa','Organizador de Mesa','Organização','74,90','assets/suporte-livros.svg'],
['suporte-controle','Suporte para Controle','Organização','64,90','assets/gato-geometrico.svg'],
['porta-celular','Porta-celular Minimalista','Organização','39,90','assets/leitor.svg'],
['busto-abstrato','Mini Busto Abstrato','Decoração','84,90','assets/leitor.svg'],
['vaso-espiral','Vaso Espiral','Decoração','94,90','assets/gatos.svg'],
['placa-personalizada','Placa Decorativa Personalizada','Presentes','54,90','assets/capivara.svg']
];
if(document.getElementById('products')){products.innerHTML=items.map(x=>`<article class="productCard"><a href="produto.html?id=${x[0]}"><div class="productPic"><img src="${x[4]}" alt="${x[1]}"></div><div class="productBody"><div class="productCat">${x[2]}</div><h3>${x[1]}</h3><div class="productMeta"><span>até 250 g</span><span>até 15 × 15 cm</span></div><div class="productPrice">R$ ${x[3]}</div><span class="productAction">Ver detalhes</span></div></a></article>`).join('');}
